...
(() => {
	...
	let elem10 = document.createElement('input');
	elem10.setAttribute("type", "button");
	document.body.append(elem10);
...
(() => {
	...
	let arr = [2, 55, 4, 3, 8, 15, 3];

	function getNumber(array, div, num) {
		if (array.includes(num)) {
			div.textContent = 'Есть такое число'
			return true;
		}
		else {
			div.textContent = 'Увы такого числа здесь нет';
			return false;
		}
	}

	getNumber(arr, output, 3);
